...
/**
 * SafeCheck typography. Uses the platform default font family for reliability across
 * devices (no bundled fonts to fail at build time). Large-text accessibility is handled
 * separately via a font-scale multiplier (see [LocalTextScale]).
 */
val SafeCheckTypography = Typography(
